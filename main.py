...
conn = mysql.connector.connect(user='root', password='Karthik29@', host='127.0.0.1', database="phonepe_pulse")
...
if SELECT == "Home":
    col1,col2, = st.columns(2)
    col1.image(Image.open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/phonepe.png"),width = 500)
    with col1:
    ...
    with col2:
        st.video("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/Mp4/upi.mp4")

        df = pd.DataFrame(rows,
                          columns=['States', 'Transaction_Year', 'Quarters', 'Transaction_Type', 'Transaction_Count',
                                   'Transaction_Amount'])
...
if SELECT == "About":
    col1, col2 = st.columns(2)
    with col1:
        st.video("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/Mp4/about.mp4")
    with col2:
        st.image(Image.open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/PhonePe_Logo.jpg"), width=500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/top.jpeg"), width=400)
        with open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/annual report.pdf", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/report.jpeg"), width=800)
...
if SELECT == "Contact":
    ...
    col3.image(Image.open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/my.jpg"), width=350)
    with col2:
